...
- Необязательный заголовок (подсказка к изображению, которая всплывает при наведении на него) гиперссылки, заключённый либо в двойные или одиночные кавычки, либо в скобки.
___
*P.S. Я хочу спать и по этому тут просто будет картинка*

![r](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSkkqKopkJ6NBsj1aTyteyz7zhbC9D7iyXYBcQH66hTjsSQf6YDCvULrz20_UDGf28Qu-0&usqp=CAU)
