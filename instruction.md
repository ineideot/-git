...
В результате на экран выводится следующее: [пример] [id] [id]: https://gist.github.com/Jekins/2bf2d0638163f1294637 "Необязательная подсказка". Иными словами, она состоит из следующих элементов:
...
Markdown позволяет также использовать неявно выраженный идентификатор (сокращенный). В этом случае метка не приводится, вместо неё текст гиперссылки используется и в качестве её имени, а вторая пара квадратных скобок остаётся пустою. Например, чтобы сделать слово «Example» гиперссылкой, ведущей на сайт https://gist.github.com/Jekins/2bf2d0638163f1294637, достаточно написать:
     ...
     [Example] [] и затем определить гиперссылку:
...
В результате на экран выводится следующее: <https://gist.github.com/Jekins/2bf2d0638163f1294637>
